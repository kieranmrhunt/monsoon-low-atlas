...
- The LPS-layer menu includes a state/weather-only mode that suppresses density, tracks, endpoints and selection overlays, leaving state rainfall or weather fields unobstructed. The choice is retained in shareable URLs as `layer=none`.
