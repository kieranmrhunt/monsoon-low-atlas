...
submit_if_incomplete ".reanalysis-runs/erainterim-full-197901-201908/parallel-finalizer.job-id" "scripts/submit_era_interim_backfill.sh"
submit_if_incomplete ".reanalysis-runs/jra55-full-195801-202401/parallel-finalizer.job-id" "scripts/submit_jra55_backfill.sh"
if [[ ! -s ".reanalysis-runs/merra2-full-1980-01-2026-07/parallel-finalizer.job-id" ]]; then
