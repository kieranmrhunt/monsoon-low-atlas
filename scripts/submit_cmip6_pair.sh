...
PRESET="${1:?provide a supported CMIP6 pair preset}"
case "$PRESET" in
  miroc6-canary|mpi-lr-canary|mri-canary|hadgem-ll-canary|miroc6-paired|mpi-lr-paired|mri-paired|hadgem-ll-paired|hadgem-mm-ssp126-canary|hadgem-mm-ssp126-paired|hadgem-mm-ssp585-canary|hadgem-mm-ssp585-paired|highres-cnrm-canary|highres-cnrm-paired|highres-ecearth-canary|highres-ecearth-paired|highres-ecearth-hr-canary|highres-ecearth-hr-paired) ;;
